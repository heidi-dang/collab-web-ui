...
export type GuestFrame =
	...
	// ── canvas frames ────────────────────────────────────────────────────────
	| { t: "canvas-stroke"; stroke: CanvasStrokeData }
	| { t: "canvas-clear" }
	| { t: "canvas-cursor"; x: number; y: number }
	// ── ping/pong ────────────────────────────────────────────────────────────
	| { t: "ping"; id: number }
	| { t: "pong"; id: number };
...
export type HostFrame =
	...
	// ── canvas frames ────────────────────────────────────────────────────────
	| { t: "canvas-snapshot"; strokes: CanvasStrokeData[] }
	| { t: "canvas-stroke"; fromPeer: number; stroke: CanvasStrokeData }
	| { t: "canvas-clear"; fromPeer: number }
	| { t: "canvas-cursor"; fromPeer: number; x: number; y: number }
	| { t: "canvas-presence"; peers: { peerId: number; name: string; color: string }[] }
	// ── ping/pong ────────────────────────────────────────────────────────────
	| { t: "ping"; id: number }
	| { t: "pong"; id: number };
 ...
 * - `4`: adds canvas frames (`canvas-snapshot`, `canvas-stroke`, `canvas-clear`,
 *   `canvas-cursor`, `canvas-presence`) and explicit ping/pong frames. Canvas
 *   frames travel through the encrypted channel alongside session frames, so
 *   no separate WebSocket or Socket.IO connection is needed.
 */
